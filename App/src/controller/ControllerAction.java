...
//
//public class ControllerAction implements ActionListener, EventChat{
...
//    
//    public ControllerAction(JPanel boxImage, Icon image) {
...
//            Logger.getLogger(ControllerAction.class.getName()).log(Level.SEVERE, null, ex);
//        }
...
//    }
//    
//    public ControllerAction(Header header, Body body, Bottom bottom) {
//        this.header = header;
//        this.body = body;
//        this.bottom = bottom;
//               
...
//        if(!text.trim().equals("")) {
//                ModelSendMessage message = new ModelSendMessage(Client.getInstance().getUser(), text, LocalDateTime.now(), header.getUser().getUserID(), UserAction.SEND_RECEIVE);
//                send(message);
...
//                if(message.getAction().equals(SEND_RECEIVE)) {
//                    if(header.getUser().getUserID() == -1) {
//                        if(message.getTo() == -1) {
